...
<form action="" id="addBlog" enctype="multipart/form-data">
    ...
    <input type="text" name="title" class="form-control py-3 h6" placeholder="Title here..." value="{{ $members->title }}">
    <br>
    <input type="text" name="slug" class="form-control py-3 h6" placeholder="Slug here... like: /slug/here.."  value="{{ $members->slug }}">
    <br>
